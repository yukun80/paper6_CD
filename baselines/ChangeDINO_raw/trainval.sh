...
python trainval.py --name S1GFloods-ChangeDINO --gpu_ids 0 --dataset S1GFloods_CD_DINO --dataroot ../../datasets --dataset_mode sar --stats_file ../../datasets/S1GFloods_CD_DINO/channel_stats_s1gfloods_train.json --batch_size 8 --fpn_channels 128 --num_epochs 100 --save_epoch_freq 10 --lr 1e-4
