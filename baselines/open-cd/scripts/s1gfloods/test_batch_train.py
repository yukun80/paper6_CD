...
class BatchTests(unittest.TestCase):
    ...
    def test_model_configs_and_defaults(self):
        ...
        self.assertEqual(len(args.models), 11)
        ...
        for model in args.models:
            ...
            cfg = b.make_config(model, args, stats)
            self.assertEqual(cfg.optim_wrapper, old.optim_wrapper)
            self.assertEqual(cfg.param_scheduler, old.param_scheduler)
            self.assertEqual(cfg.train_pipeline, old.train_pipeline)
            ...
            self.assertEqual(cfg.default_hooks.checkpoint.save_best, 'mIoU')
            ...
            smoke = b.make_config(model, args, stats)
    ...
    def jobs(self, codes):
        ...
        for index, code in enumerate(codes):
            ...
            if code == 0:
                source += f'Path({str(work / "best_mIoU_iter_40000.pth")!r}).touch(); '
