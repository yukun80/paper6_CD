...
from opencd.models.backbones.vit_sam import (Attention, build_norm_layer,
                                             window_partition,
                                             window_unpartition)
...
class TimeFusionTransformerEncoderLayer(BaseModule):
    ...
    def __init__(self,
        ...
        if self.window_size > 0:
            ...
            self.down_channel = torch.nn.Conv2d(
                in_channels, 1, kernel_size=1, stride=1, bias=False)
