...
3: & Extract the outer boundary and retain candidates that satisfy the slope and local median-deviation criteria; extract the inner wet boundary by erosion. \\
4: & Pair the wet- and dry-side boundary medians and construct the water-surface anchor \(S_b=\max[(Z_{\mathrm{wet}}+Z_{\mathrm{dry}})/2,\,Z+d_{\min}]\). \\
