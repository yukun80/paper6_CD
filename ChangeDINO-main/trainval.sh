...
python trainval.py --name S1GFloods-ChangeDINO --gpu_ids 0 --dataset S1GFloods_CD --dataroot ../datasets --dataset_mode sar --stats_file ../datasets/S1GFloods_CD/channel_stats_s1gfloods_train.json --batch_size 16 --fpn_channels 128 --num_epochs 100 --lr 1e-4
