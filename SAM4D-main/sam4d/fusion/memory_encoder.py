...
from sam4d.utils import DropPath, get_clones, LayerNorm2d
from sam4d.position_encoding import PositionEmbeddingSine
...
class Fuser(nn.Module):
    def __init__(self, layer, num_layers, dim=None, input_projection=False):
        ...
        self.layers = get_clones(CXBlock(**layer), num_layers)
